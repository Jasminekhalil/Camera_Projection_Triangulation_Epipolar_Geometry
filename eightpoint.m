%% Function for calculating F using the eightpoint algorithm with Hartley preconditioning 
...
fprintf('F matrix with normalization):\n');
for j=1:3
    for i=1:3
...
% Returning the points selected for eight point algorithm without Hartley preconditioning
